...
class CoffeeMachine
{
    ...
    static private  CoffeeMachine our=null;//static variable use as reference for an object
    ...
    {
        if(our==null)//if reference is null than only object will get created once 
        {
